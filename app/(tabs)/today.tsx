...
const mockHoroscopeData: HoroscopeData[] = [
  {
    ...
    preview: "Today brings powerful energy for new beginnings, Aries. Your natural leadership shines as opportunities emerge in unexpected places. Trust your instincts when making important decisions, especially around midday. A conversation with someone from your past could open doors you thought were closed.",
  ...
  },
  {
    ...
    preview: "This week focuses on building lasting foundations while embracing necessary changes. Monday and Tuesday highlight career advancement opportunities, while the weekend brings romantic possibilities. Your ruling planet Mars energizes your ambition sector.",
  ...
  },
  {
    ...
    preview: "March opens with transformative energy that will reshape your perspective on personal goals. The new moon on the 13th brings fresh opportunities in your career sector, while Venus retrograde from the 22nd asks you to revisit past relationships.",
  ...
  },
  {
    ...
    preview: "2024 is your year of authentic self-expression and bold leadership. Jupiter's presence in your expansion sector until May supports major life upgrades, while Saturn teaches valuable lessons about long-term commitment and responsibility.",
    ...
    <SafeAreaProvider>
      <View style={styles.container}>
        ...
        >
          ...
          {/* Life Aspects */}
          <LifeAspects data={mockLifeAspects} />
